...
> [图 D.19]（#_ bookmark560）显示了标准 VME 机架中的群集。40 GB2000 符合标准 VME 机架，可为原始容量提供 80 吨的架子。40 个节点与 48-port 10/100 或 10/100/1000 开关连接，并消散约 3 kW。在计算机设施中，限制通常为每个机架 10 kW，因此在准则之内。
